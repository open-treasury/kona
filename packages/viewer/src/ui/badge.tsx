 ...
 * circular glyph in `graph/ActivityCard.tsx`, in the GitHub Actions idiom: a ring you read by its
...
const badge = tv({
  ...
  variants: {
    tone: {
      /** Qualifies an activity rather than stating it — the quorum counter. */
