...
describe("readinessOf", () => {
  test("the fixture is the eight-version pursuit these tests were written against", () => {
    expect(HEAD).toBe(7);
  });
...
describe("blockedReason", () => {
  ...
  test("a source still in flight: wait-for-pat behind Pat's send at v7", () => {
    const graph = graphAt(7);
