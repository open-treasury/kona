...
The one thing that stops is *a new irreversible effect to a recipient the graph has never
seen*. At n=60, when the graph became unsatisfiable, the mutator's most common repair was to
...
write nobody asked for. It reports, and says what it *would* repair.
